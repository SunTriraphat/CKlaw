! function (a) {
    ...
    a.sessionTimeout = function (b) {
        ...
        function d() {
            clearTimeout(g), (i.countdownMessage || i.countdownBar) && f("session", !0), "function" == typeof i.onStart && i.onStart(i), i.keepAlive , g = setTimeout(function () {
        ...
        function e() {
            clearTimeout(g), $("#session-timeout-dialog").hasClass("in") || !i.countdownMessage && !i.countdownBar || f("dialog", !0), g = setTimeout(function () {
        ...
        var g, h = {
                title: "Your Session is About to Expire! Chookiat",
        ...
        if (!i.ignoreUserActivity) {
            ...
            a(document).on("keyup mouseup mousemove touchend touchmove", function (b) {
                ...
                d(), $("#session-timeout-dialog").length > 0 && $("#session-timeout-dialog").data("bs.modal") && $("#session-timeout-dialog").data("bs.modal").isShown && ($("#session-timeout-dialog").modal("hide"), a("body").removeClass("modal-open"), a("div.modal-backdrop").remove())
            })
        }
        var n = !1;
        d()
