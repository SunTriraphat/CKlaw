...
<div class="card border border-white mb-2 p-2">
    <div class="card-title">
        ...
        <a data-link="{{ route('Law.show', $item->id) }}?type={{ 'Editcus4' }}" data-bs-toggle="modal"
        ...
        <div class="row">
            <div class="col-6">
                <table class="table table-sm">
                    <tr>
                        <th class="text-start">วันที่ตรวจ</th>
                        <td class="text-end">content 1</td>
                    </tr>
                    <tr>
                        <th class="text-start">วันตรวจจริง</th>
                        <td class="text-end">content 1</td>
                    </tr>
                    <tr>
                        <th class="text-start">ผู้ค้ำ 1 ได้รับ </th>
                        <td class="text-end">content 1</td>
                    </tr>
                    <tr>
            ...
            <div class="col-6">
                <table class="table table-sm">
                    <tr>
                        <th class="text-start">ผู้ซื้อได้รับ</th>
                        <td class="text-end">content 1</td>
                    </tr>
                    <tr>
                        <th class="text-start">title1</th>
                    ...
                    <tr>
                        <th class="text-start">ผู้ค้ำ 2 ได้รับ</th>
                        <td class="text-end">content 1</td>
                    </tr>
                    <tr>
                        <th class="text-start">title1</th>
