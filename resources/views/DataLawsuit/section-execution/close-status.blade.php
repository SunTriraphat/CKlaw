            ...
            <form id='edit_Tribunal'>
                ...
                <div class="modal-footer">
                    ...
                    @if (@$data->status_close != 'Y' )
                        ...
                        @if(@$data->CusToClose->discountApp != 'อนุมัติ')
                        <button type="button" class="btn btn-primary " id="discountAppExeBtn">ขออนุมัติส่วนลด</button>
                        @endif
...
<script>
    ...
    function autoTotalPay() {
        ...
        let diff_pay = parseFloat(totalSum.value) - parseFloat(discount.value);

        if (diff_pay < 0) {
            diff_pay = 0;
        }

        total_pay.value = diff_pay;
...
<script type="text/javascript">
    $(function() {
        ...
        let discountApp = $('#discountApp').val();
        ...
        $('#SaveBtn').click(function(e) {
            ...
            let link = "{{ route('Exe.update', 'cus_id') }}?type={{ 'CloseStatus' }}";
        ...
        $('#discountAppExeBtn').click(function(e) {
        ...
        $('#discountCancelBtn').click(function(e) {
            ...
            let link = "{{ route('Exe.update', 'cus_id') }}?type={{ 'discountAppCancel' }}";
            let url = link.replace('cus_id', cus_id);
            console.log(url);
        ...
        $('#NotAppBtn').click(function(e) {
            ...
            let link = "{{ route('Exe.update', 'cus_id') }}?type={{ 'discountAppNot' }}";
            let url = link.replace('cus_id', cus_id);
            console.log(url);
        ...
        $('#AppBtn').click(function(e) {
            ...
            let link = "{{ route('Exe.update', 'cus_id') }}?type={{ 'discountApp' }}";
            let url = link.replace('cus_id', cus_id);
            console.log(url);
