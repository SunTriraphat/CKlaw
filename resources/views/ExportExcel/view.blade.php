            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="mb-3 input-bx">
                        <span> ตั้งแต่</span>
                        <input type="date" lang="th-th" value="{{ trim(@$item->fdate) }}"
                            name="fdate" id="fdate" class="form-control">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="mb-3 input-bx">
                        <span> ถึง</span>
                        <input type="date" lang="th-th" value="{{ trim(@$item->tdate) }}"
                            name="tdate" id="tdate" class="form-control">
                    </div>
                </div>
            </div>
