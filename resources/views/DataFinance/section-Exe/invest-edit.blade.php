                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="mb-3 input-bx">
                            ...
                            <input type="text" class="form-control" value="{{ $dataFinance->investigation_fee }}"
                                name="investigation_fee" id="investigation_fee" required placeholder=" "
                                {{ $dataFinance->status == 'อนุมัติ' ? 'disabled' : '' }} />
                        </div>
                    ...
                    <div class="col-sm-6 ">
                        ...
                        <div class="mb-3 input-bx">
                            <span>ค่านำชี้</span>
                            <input type="text" class="form-control" value="{{ $dataFinance->property_iden }}"
                                name="property_iden" id="property_iden" required
                                {{ $dataFinance->status == 'อนุมัติ' ? 'disabled' : '' }} />
                        </div>
                        {{-- <div class="mb-3 input-bx">
...
<script type="text/javascript">
    $(function() {
        ...
        $('#saveEditBtn').click(function(e) {
            ...
            var link = `{{ route('Fin.update', 'id') }}?type={{ 'UpdateInvest' }}`;
