            ...
            <form id='edit_invest'>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="mb-3 input-bx">
                            ...
                            <input type="text" class="form-control" name="investigation_fee" id="investigation_fee"
                    ...
                    <div class="col-sm-6 ">
                        ...
                        <div class="mb-3 input-bx">
                            <span>ค่านำชี้</span>
                            <input type="text" class="form-control" name="property_iden" id="property_iden"
                                required />
                        </div>
                        {{-- <div class="mb-3 input-bx">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary " id="saveEditBtn">
                        <span class="spinner-border spinner-border-sm" role="status" id="loading-invert"
                            aria-hidden="true" style="display: none"></span>บันทึก
                    </button>




                    <button type="button" class="btn btn-danger " id="close-invert" class="close"
...
<script type="text/javascript">
    $(function() {
        ...
        $('#saveEditBtn').click(function(e) {
            ...
            $('#close-invert').prop('disabled', true);
            $('#loading-invert').show();
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    $('#close-invert').prop('disabled', false);
                    $('#loading-invert').hide();
