            ...
            <form id='edit_sue'>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="mb-3 input-bx">
                            <span>ผู้ขอเบิก</span>
                            <input type="text"class="form-control"value="{{ $dataFinance->Applicant }}" name="Applicant"
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="mb-3 input-bx">
                            ...
                            <input type="text" class="form-control" value="{{ $dataFinance->setup_con }}"
                                name="setup_con" id="setup_con" required placeholder=" "
                                {{ $dataFinance->status == 'อนุมัติ' ? 'disabled' : '' }} />
                        </div>
                    ...
                    <div class="col-sm-6">
                        <div class="mb-3 input-bx">
                            ...
                            <input type="text" class="form-control" value="{{ $dataFinance->auction_announce }}"
                                name="auction_announce" id="auction_announce" required placeholder=" "
                                {{ $dataFinance->status == 'อนุมัติ' ? 'disabled' : '' }} />
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="mb-3 input-bx">
                            ...
                            <input type="text" class="form-control" value="{{ $dataFinance->withdraw_execution }}"
                                name="withdraw_execution" id="withdraw_execution" required placeholder=" "
                                {{ $dataFinance->status == 'อนุมัติ' ? 'disabled' : '' }} />
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary " id="saveEditBtn">แก้ไข</button>
...
<script type="text/javascript">
    $(function() {
        ...
        $('#saveEditBtn').click(function(e) {
            ...
            var link = `{{ route('Fin.update', 'id') }}?type={{ 'UpdateCon' }}`;
