            ...
            <form id='edit_invest'>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="mb-3 input-bx">
                            <span>คัดถ่ายและรับรองเอกสาร</span>
                            <input type="text" class="form-control" name="copy_documents3" id="copy_documents3"
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary " id="saveEditBtn">
                        <span class="spinner-border spinner-border-sm" role="status" id="loading-deed"
                    ...
                    <button type="button" class="btn btn-danger " id="close-deed" class="close"
        ...
        $('#saveEditBtn').click(function(e) {
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    $('#close-deed').prop('disabled', false);
                    $('#loading-deed').hide();
                },
                error: function(err) {
                    console.log(err);
