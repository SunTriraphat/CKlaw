                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="mb-3 input-bx">
                            ...
                            <input type="text" class="form-control" value="{{ $dataFinance->copy_documents3 }}"
                                name="copy_documents3" id="copy_documents3" required placeholder=" "
                                {{ $dataFinance->status == 'อนุมัติ' ? 'disabled' : '' }} />
                        </div>
...
<script type="text/javascript">
    $(function() {
        ...
        $('#saveEditBtn').click(function(e) {
            ...
            var link = `{{ route('Fin.update', 'id') }}?type={{ 'UpdateDeed' }}`;
