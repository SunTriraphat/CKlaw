            ...
            <form id='edit_com'>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="mb-3 input-bx">
                            ...
                            <input type="text" class="form-control" value="{{ trim(@$item->mandatory_fee) }}"
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary " id="saveEditBtn">
                        <span class="spinner-border spinner-border-sm" role="status" id="loading-command"
                            aria-hidden="true" style="display: none"></span>
                        บันทึก
                    </button>

                    <button type="button" class="btn btn-danger " class="close" id="close-command"
...
<script type="text/javascript">
    $(function() {
        ...
        $('#saveEditBtn').click(function(e) {
            ...
            $('#close-command').prop('disabled', true);
            $('#loading-command').show();
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    $('#close-command').prop('disabled', false);
                    $('#loading-command').hide();
                    Swal.fire({
                        icon: 'success',
                        title: `SUCCESS `,
