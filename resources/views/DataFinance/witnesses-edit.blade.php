            ...
            <form id='edit_sue'>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        {{-- <div class="mb-3 ">
                                ...
                                <input type="text"class="form-control" value="{{ trim(@$dataFinance->CON_NO) }}"
                        ...
                        {{-- <div class="mb-3 input-bx">
                            ...
                            <input type="text" class="form-control" value="{{ trim(@$dataFinance->mandatory_fee) }}"
                                name="mandatory_fee" id="mandatory_fee" required placeholder=" "
                                {{ $dataFinance->status == 'อนุมัติ' ? 'disabled' : '' }} />
                        </div> --}}
                        {{-- <div class="mb-3 input-bx">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary " id="saveEditBtn">
                        <span class="spinner-border spinner-border-sm" role="status" id="loading2-witness"
                    ...
                    <button type="button" class="btn btn-danger" id="close2-witness" class="close"
...
<script type="text/javascript">
    $(function() {
        ...
        $('#saveEditBtn').click(function(e) {
            ...
            $('#close2-witness').prop('disabled', true);
            $('#loading2-witness').show();
            let num = parseInt($('#num').val());
            ...
            var link = `{{ route('Fin.update', 'id') }}?type={{ 'UpdateWitness' }}`;
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    $('#close2-witness').prop('disabled', false);
                    $('#loading2-witness').hide();
                    Swal.fire({
                        icon: 'success',
                        title: `SUCCESS `,
