            ...
            <form id='edit_com'>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary " id="saveEditBtn">
                        <span class="spinner-border spinner-border-sm" role="status" id="loading2-command"
...
<script type="text/javascript">
    $(function() {
        ...
        $('#saveEditBtn').click(function(e) {
            ...
            var link = `{{ route('Fin.update', 'id') }}?type={{ 'UpdateCommand' }}`;
