    ...
    <div class="modal-body">
        <div class="col-12 mt-3">
            <form id='edit_property'>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="mb-3 input-bx">
                            ...
                            <input type="text" class="form-control" value="{{ trim(@$item->check_ownership) }}"
                                name="check_ownership" id="check_ownership" required placeholder=" " />
                        </div>
                    ...
                    <div class="col-sm-6 ">
                        <div class="mb-3 input-bx">
                            ...
                            <input type="text" class="form-control" value="{{ trim(@$item->copy_documents2) }}"
                                name="copy_documents2" id="copy_documents2" required />
                        </div>
                    ...
                    <div class="col-sm-6 ">
                        ...
                        <div class="mb-3 input-bx">
                            ...
                            <input type="text" class="form-control" value="{{ trim(@$item->point_property) }}"
                    ...
                    <div class="row">
                        <div class="mb-3 input-bx">
                            ...
                            <input type="hidden"class="form-control"
                                value="{{ @$other != null ? count(@$other) : '0' }}" name="num" id="num"
                                required placeholder=" " />
                            <input type="hidden"class="form-control" value="1" name="countNum" id="countNum"
                                required placeholder=" " />
                        </div>
                        @if ($finFuture != null)
                            <div class="col-6">
                ...
                {{-- <div>
                    @foreach ($other as $i => $oth)
                        <div class="row">
                            <div class="col-sm-6 mb-2">
                                <input type="text"class="form-control" value="{{ trim(@$oth->name) }}"
                                    name="name{{ $i + 1 }}" id="name{{ $i + 1 }}" required
                                    placeholder=" " />
                                <input type="hidden"class="form-control" value="{{ @$oth->id !=NULL ?  trim(@$oth->id) : NULL }}"
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary " id="propertyBtn">
                        <span class="spinner-border spinner-border-sm" role="status" id="loading-prop"
                            aria-hidden="true" style="display: none"></span>

                        บันทึก
                    </button>
                    <input type="hidden"class="form-control" value="POST" name="method" id="method" required
                        placeholder=" " />
        ...
        $('#propertyBtn').click(function(e) {
            ...
            $.ajax({
                ...
                success: function(result) {
                    $('#propertyBtn').prop('disabled', false);
                    $('#loading-prop').hide();
