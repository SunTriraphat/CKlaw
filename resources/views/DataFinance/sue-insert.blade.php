            ...
            <form id='edit_sue'>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="mb-3 input-bx">
                            <span>เลขบิล</span>
                            <input type="text" class="form-control" value="{{ @$bill_no }}" name="bil_no"
                        ...
                        <div class="mb-3 input-bx">
                            ...
                            <input type="text" class="form-control" name="court_fee" id="court_fee" required
                                placeholder=" " />
                        </div>
                    ...
                    <div class="col-sm-6 ">
                        ...
                        <div class="mb-3 input-bx">
                            ...
                            <input type="text" class="form-control" name="send_defendant" id="send_defendant"
                                required />
                        </div>
                        {{-- <div class="mb-3 input-bx">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <input type="hidden" class="form-control" value="{{$finFuture->id}}" name="fin_id" id="fin_id"
                        required placeholder=" " />
                    </div>
                    @endif
                </div>
