            ...
            <form id='edit_sue'>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="mb-3 input-bx">
                            ...
                            <input type="text" class="form-control" value="{{ $dataFinance->court_fee }}"
                    ...
                    <div class="col-sm-6 ">
                        ...
                        <div class="mb-3 input-bx">
                            ...
                            <input type="text" class="form-control" value="{{ $dataFinance->send_defendant }}"
                                name="send_defendant" id="send_defendant" required
                                {{ $dataFinance->status == 'อนุมัติ' ? 'disabled' : '' }} />
                        </div>
                        {{-- <div class="mb-3 input-bx">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="mb-3 input-bx">
                                ...
                                <input type="hidden"class="form-control"
                                    value="{{ @$dataFinance->FinanceToFinOther != null ? count(@$dataFinance->FinanceToFinOther) : '0' }}"
                                    name="countNum" id="countNum" required placeholder=" " />
                            </div>
                        </div>

                        @if ($finFuture != null)
                            <div class="col-6">
                                <input type="checkbox" value="Y" id="Finfuture" name="Finfuture" {{$dataFinance->id_finFuture != NULL ? 'checked' : ''}}/>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary " id="saveEditBtn">
                        <span class="spinner-border spinner-border-sm" role="status" id="loading2-sue"
                            aria-hidden="true" style="display: none"></span>
                        แก้ไข</button>
                    <input type="hidden"class="form-control" value="PUT" name="method" id="method" required
                        placeholder=" " />

                    <button type="button" class="btn btn-danger " id="close2-sue" class="close"
...
<script type="text/javascript">
    $(function() {
        ...
        $('#saveEditBtn').click(function(e) {
            ...
            var link = `{{ route('Fin.update', 'id') }}?type={{ 'UpdateSue' }}`;
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    $('#close2-sue').prop('disabled', false);
                    $('#loading2-sue').hide();
