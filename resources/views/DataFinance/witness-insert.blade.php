            ...
            <form id='edit_sue'>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 ">
                        ...
                        <div class="mb-3 input-bx">
                            ...
                            <input type="text" class="form-control" value="{{ trim(@$item->copy_documents1) }}"
                                name="copy_documents1" id="copy_documents1" required />
                        </div>
                        {{-- <div class="mb-3 input-bx">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary " id="saveEditBtn">
                        <span class="spinner-border spinner-border-sm" role="status" id="loading-witness"
                    ...
                    <button type="button" class="btn btn-danger " id="close-witness" class="close"
...
<script type="text/javascript">
    $(function() {
        ...
        $('#saveEditBtn').click(function(e) {
            ...
            $('#close-witness').prop('disabled', true);
            $('#loading-witness').show();
            let num = parseInt($('#num').val());
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    $('#close-witness').prop('disabled', false);
                    $('#loading-witness').hide();
