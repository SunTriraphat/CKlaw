                ...
                <form id="addUser">
                    ...
                    <div class="p-5">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4"><i class="fa-solid fa-users-gear"></i>
                                แก้ไขข้อมูลผู้ใช้งาน !</h1>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col">
                                <input type="email" class="form-control form-control-user email"
                                    value="{{ $user->email }}" name="email" placeholder="Email Address">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-3">
                            ...
                            <div class="col">
                                <input type="text" class="form-control form-control-user password"
                                    value="{{ $user->password_val }}" name="password" placeholder="Password"
                                    fdprocessedid="ipr90s">
                            </div>
                        </div>
                        <hr>
                        <div class="form-group row">
                                ...
                                <select class="form-select position" name="position">
                                    ...
                                    @foreach (@$user_status as $item)
                                        <option value="{{ $item->name }}"
                                            {{ $user->position == $item->name ? 'selected' : '' }}>
                        ...
                        @if ($user->password != 'NULL')
                            <button type="button" class="btn btn-warning btn-addUser btn-block rounded-pill"
                                id="btn-editUser">
                                แก้ไขผู้ใช้งาน
                            </button>
                        @else
