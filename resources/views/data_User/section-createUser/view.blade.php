                ...
                <form id="addUser">
                    ...
                    <div class="p-5">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4"><i class="fa-solid fa-user-check"></i> เพิ่มผู้ใช้งานใหม่
                                !</h1>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col">
                                <input type="text" class="form-control form-control-user name" name="name"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col">
                                <input type="email" class="form-control form-control-user email" name="email"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col">
                                <input type="text" class="form-control form-control-user password" name="password"
                                    placeholder="Password" fdprocessedid="ipr90s">
                            </div>
                        </div>
                        <hr>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <select class="form-select position" name="position">
                                    ...
                                    @foreach (@$user_status as $item)
                                        <option value="{{ $item->name }}">{{ $loop->iteration }}.{{ $item->name }}
                                        </option>
                                    @endforeach
                                </select>
                                {{-- <select class="form-select position" name="position">
                        ...
                        <button type="button" class="btn btn-primary btn-addUser btn-block rounded-pill"
                            id="btn-addUser">
                            เพิ่มผู้ใช้
                        </button>
                    </div>
