...
class StaticController extends Controller
{
    ...
    public function create(Request $request)
    {
        if ($request->func == 'addUser') {
            ...
            return view('data_User.section-createUser.view',compact('user_status'));
        }
    ...
    public function edit(Request $request, $id)
    {
        ...
        if ($request->type == 1) { //แก้ไขข้อมูลผู้ใช้งาน
            ...
            $user_status = UserStatus::get();
            // dd($user_status);
            return view('data_User.section-editUser.editUser', compact('user','user_status'));
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        //         $data->save();
        //     }
        if ($request->func == 'editUser') { //แก้ไข User
